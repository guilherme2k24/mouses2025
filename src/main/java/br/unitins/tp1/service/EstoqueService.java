...
public class EstoqueService {
    ...
    public EstoqueResponseDTO salvar(EstoqueRequestDTO dto) {
        ...
        // Converter o mouse para MouseResponseDTO antes de retornar
