 ...
 * Os itens de pedido devem ser gerenciados através do endpoint /pedidos.
 * Isso mantém a lógica de negócio no backend e garante consistência dos dados.
 * 
 * Use POST /pedidos com a lista de itens para criar pedidos completos.
 * Use PUT /pedidos/{id} para atualizar pedidos e seus itens.
 */
@Deprecated
@Path("/itenspedido")
