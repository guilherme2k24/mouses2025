...
public class ItemDoPedido {
    ...
    // ✅ Mantém o preço da época da compra (não muda se o mouse alterar de preço depois)
    ...
    // ✅ Em produção, geralmente o precoUnitario deve ser definido apenas no momento da criação do item
