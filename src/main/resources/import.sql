...
-- Mouse
INSERT INTO mouses(botoes, conexao, dpi, peso, pollingrate, cor, formato, modelo, sensor) VALUES
(6, 'SEM_FIO', 16000, 85.5, 1000, 'Preto', 'Ergonomico', 'G502', 'Optico'),
(5, 'COM_FIO', 8000, 70.0, 500, 'Branco', 'Ambidestro', 'Basilisk X', 'Laser');
